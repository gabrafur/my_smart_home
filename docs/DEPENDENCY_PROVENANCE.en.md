...
| --- | --- | --- | --- | --- | --- | --- |
| Alexa Media Player | [`alandtse/alexa_media_player`](https://github.com/alandtse/alexa_media_player) | `v5.15.7`, `eef9f9c95645c485b4028cd2dc7154f9493093de` | Apache-2.0 | none across 39 tracked files | replace from the release, check the manifest, retain `LICENSE.upstream`, and preserve Apache notices | verified |
