...
| `atualizacoes_diarias` | Migrado e implantado | DietPi → Core → demais containers serializados; `update.*` classificado visualmente entre Bluelink, HACS versionado, firmware e desconhecido; parsers remanescentes apenas adaptam estruturas e contratos sanitizados |
