...
| --- | --- | --- | --- | --- | --- | --- |
| Alexa Media Player | [`alandtse/alexa_media_player`](https://github.com/alandtse/alexa_media_player) | tag `v5.15.7`, commit `eef9f9c95645c485b4028cd2dc7154f9493093de` | Apache-2.0 | nenhuma nos 39 arquivos rastreados comparados | substituir pelo diretório da release, conferir manifest e manter `LICENSE.upstream`; preservar licença e notices exigidos pela Apache-2.0 | verificado |
