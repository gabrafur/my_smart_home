...
| Observability | [monitoring](docs/ZIGBEE_HEALTH_NOTIFICATIONS.en.md), [global Node-RED failures](docs/NODERED_GLOBAL_FAILURE_NOTIFICATIONS.md), [host health](docs/RASPBERRY_PI_SYSTEM_HEALTH.md), [runtime tests](nodered/tools/test-infrastructure-monitoring-runtime.mjs) | outage, recovery, and deduplication are testable states, not only logs |
