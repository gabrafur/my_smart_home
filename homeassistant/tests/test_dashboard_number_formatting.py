...
NUMERIC_EXPRESSION_MARKERS = (
    ...
    "fallback_cases",
    "useful_cases",
    "useful_rtx_rate_among_attempts",
    "end_to_end_useful_coverage",
    "critical_error_occurrences",
    "cases_with_critical_error",
    "estimated_avoided_gpt_tokens",
    "estimated_weighted_gpt_context_reduction",
    "local_added_latency_total_seconds",
    "rtx_quality_score",
    "baseline_quality_score",
    "rtx_latency_p50_seconds",
    "baseline_latency_p50_seconds",
    "idade_benchmark_s",
)
...
DASHBOARD_COUNTERS = (
    ...
    "codex_chamadas_operacionais_local_ai",
    "codex_conclusoes_operacionais_local_ai",
    "codex_conclusoes_operacionais_local_ai_hoje",
    "codex_falhas_operacionais_local_ai",
    "codex_resultados_operacionais_sem_classificacao_de_qualidade",
    "codex_resultados_operacionais_sem_classificacao_de_qualidade_hoje",
    "codex_resultados_local_ai_rejeitados_no_gate",
    "codex_resultados_local_ai_com_gate_hoje",
    "codex_resultados_local_ai_aprovados_no_gate",
    "codex_resultados_local_ai_aprovados_no_gate_hoje",
    "codex_resultados_local_ai_aprovados_sem_custo_mensuravel",
    "codex_resultados_local_ai_aprovados_sem_custo_mensuravel_hoje",
    "codex_contexto_tentado_local_ai",
    "codex_resultados_local_ai_sem_ganho_liquido",
    "codex_resultados_local_ai_sem_ganho_liquido_hoje",
    "codex_falhas_operacionais_local_ai_hoje",
