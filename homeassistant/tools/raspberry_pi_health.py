...
def storage_maintenance_metrics() -> dict:
    ...
    keys = (
        ...
        "docker_build_cache_logical_bytes",
        "docker_build_cache_reclaimable_bytes",
        "docker_unused_tagged_logical_bytes",
        "docker_unused_untagged_logical_bytes",
        "docker_reclaimable_untagged_logical_bytes",
        "docker_protected_untagged_logical_bytes",
        "docker_recent_untagged_logical_bytes",
        "known_logs_bytes",
        "repository_bytes",
        ...
        "home_assistant_expired_manual_snapshots_logical_bytes",
        "home_assistant_manual_snapshot_retention_days",
        "deleted_open_bytes",
        "deleted_open_count",
