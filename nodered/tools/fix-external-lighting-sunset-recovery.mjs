...
return msg;`,
  ...
  },
  {
    ...
    entityId: [],
    labelId: [],
    data: '{"role":"mobile_primary","action":"notify_3","data":{"title": notification_title, "message": notification_message, "data": {"tag": notification_tag, "actions": [{"action": confirm_action, "title": "Ligar"}, {"action": cancel_action, "title": "Não ligar"}]}}}',
    dataType: "jsonata",
    mergeContext: "",
