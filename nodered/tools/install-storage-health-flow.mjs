...
const nodes = [
  ...
  { id: "storage_notify", type: "api-call-service", z: TAB, g: "storage_group_alerts", name: "Avisar moradores", server: SERVER, version: 7, debugenabled: false, action: "notify.send_message", floorId: [], areaId: [], deviceId: [], entityId: ["notify.mobile_primary_2", "notify.mobile_secondary"], labelId: [], data: "{\"title\": payload.title, \"message\": payload.message}", dataType: "jsonata", mergeContext: "", mustacheAltTags: false, outputProperties: [], queue: "all", blockInputOverrides: true, domain: "notify", service: "send_message", x: 1430, y: 310, wires: [[]] },
