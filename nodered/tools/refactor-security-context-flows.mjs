...
function rawEvent(source, event = "location_update") {
  ...
  const domain = source === "vehicle_primary"
    ? [
        ...
        `"vehicle_primary_last_updated": $entities("sensor.vehicle_primary_last_updated_at")`,
      ]
    : [
...
const telemetryUpdatedAt = Date.parse(
...
const vehicleContext = {
    ...
    telemetry_updated_at: Number.isFinite(telemetryUpdatedAt) ? telemetryUpdatedAt : null,
...
nodes.push(clone("sec_vehicle_primary_location_changed", { id: "vehicle_primary_location_event", z: VEHICLE_PRIMARY_TAB, g: "grp_vehicle_primary_events", name: "Localização ou telemetria do vehicle_primary mudou", entities: { entity: ["device_tracker.vehicle_primary", "sensor.vehicle_primary_last_updated_at"], substring: [], regex: [] }, outputProperties: [{ property: "payload", propertyType: "msg", value: rawEvent("vehicle_primary"), valueType: "jsonata" }], x: 230, y: 180, wires: [["vehicle_primary_normalize"]] }));
nodes.push(clone("sec_vehicle_primary_lock_context_changed", { id: "vehicle_primary_lock_event", z: VEHICLE_PRIMARY_TAB, g: "grp_vehicle_primary_events", name: "Estado da trava do vehicle_primary mudou", outputProperties: [{ property: "payload", propertyType: "msg", value: `(\n  {"event":"context_update","source":"vehicle_primary","vehicle_primary":$entities("device_tracker.vehicle_primary"),"vehicle_primary_engine":$entities("binary_sensor.vehicle_primary_engine"),"vehicle_primary_lock":$entities("lock.vehicle_primary_door_lock"),"vehicle_primary_last_updated":$entities("sensor.vehicle_primary_last_updated_at")}\n)`, valueType: "jsonata" }], x: 230, y: 240, wires: [["vehicle_primary_normalize"]] }));
nodes.push(clone("sec_engine_off_changed", { id: "vehicle_primary_engine_off_event", z: VEHICLE_PRIMARY_TAB, g: "grp_vehicle_primary_events", name: "Motor desligado por 5 s", outputProperties: [{ property: "payload", propertyType: "msg", value: `(\n  {"event":"turn_off","reason":"vehicle_primary_engine_off","source":"vehicle_primary","vehicle_primary":$entities("device_tracker.vehicle_primary"),"vehicle_primary_engine":$entities("binary_sensor.vehicle_primary_engine"),"vehicle_primary_lock":$entities("lock.vehicle_primary_door_lock"),"vehicle_primary_last_updated":$entities("sensor.vehicle_primary_last_updated_at")}\n)`, valueType: "jsonata" }], x: 230, y: 300, wires: [["vehicle_primary_normalize"]] }));
nodes.push(clone("sec_vehicle_primary_locked_changed", { id: "vehicle_primary_unlock_event", z: VEHICLE_PRIMARY_TAB, g: "grp_vehicle_primary_events", name: "Porta destravada por 5 s", outputProperties: [{ property: "payload", propertyType: "msg", value: `(\n  {"event":"turn_off","reason":"vehicle_primary_unlocked","source":"vehicle_primary","vehicle_primary":$entities("device_tracker.vehicle_primary"),"vehicle_primary_engine":$entities("binary_sensor.vehicle_primary_engine"),"vehicle_primary_lock":$entities("lock.vehicle_primary_door_lock"),"vehicle_primary_last_updated":$entities("sensor.vehicle_primary_last_updated_at")}\n)`, valueType: "jsonata" }], x: 230, y: 360, wires: [["vehicle_primary_normalize"]] }));
