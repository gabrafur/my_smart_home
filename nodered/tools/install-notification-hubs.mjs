...
export const NOTIFICATION_MIGRATIONS = Object.freeze([
  ...
  mobile("2818bf202b397612", "iluminacao_seguranca", "resident_primary", "actionable", '_notification_hub_context.payload.test_mode=true ? "Casa inteligente — TESTE" : "Casa inteligente"', '_notification_hub_context.payload.actuator_confirmation_pending=true ? (_notification_hub_context.payload.test_mode=true ? "[TESTE] O comando para ligar o refletor foi enviado enquanto ele estava indisponível; aguardando confirmação." : "O comando para ligar o refletor foi enviado enquanto ele estava indisponível; aguardando confirmação.") : (_notification_hub_context.payload.test_mode=true ? "[TESTE] O refletor da garagem foi ligado." : "O refletor da garagem foi ligado.")', null, { testMode: "_notification_hub_context.payload.test_mode = true" }),
  mobile("light_notify_on_secondary", "iluminacao_seguranca", "resident_secondary", "actionable", '_notification_hub_context.payload.test_mode=true ? "Casa inteligente — TESTE" : "Casa inteligente"', '_notification_hub_context.payload.actuator_confirmation_pending=true ? (_notification_hub_context.payload.test_mode=true ? "[TESTE] O comando para ligar o refletor foi enviado enquanto ele estava indisponível; aguardando confirmação." : "O comando para ligar o refletor foi enviado enquanto ele estava indisponível; aguardando confirmação.") : (_notification_hub_context.payload.test_mode=true ? "[TESTE] O refletor da garagem foi ligado." : "O refletor da garagem foi ligado.")', null, { testMode: "_notification_hub_context.payload.test_mode = true" }),
