...
const nodes = [
  ...
  { id: GROUP, type: "group", z: TAB, name: "Alertas Codex → iPhone de Gabriel", style: { label: true, "label-position": "nw", stroke: "#5d6f96", "stroke-opacity": "1", fill: "none", color: "#a4a4a4" }, nodes: ["codex_alert_state", "codex_alert_manual_test", "codex_alert_daily", "codex_alert_logic", "codex_alert_push", "codex_alert_text", "codex_alert_time", "codex_alert_persistent"], x: 40, y: 40, w: 1520, h: 280 },
