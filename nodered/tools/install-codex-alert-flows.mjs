...
const nodes = [
  ...
  node("codex_alert_push", "api-call-service", { g: GROUP, name: "Push iPhone resident_primary", server: HA, version: 7, debugenabled: false, action: "notify.mobile_primary_3", floorId: [], areaId: [], deviceId: [], entityId: [], labelId: [], data: "{\"title\":alert.title,\"message\":alert.message}", dataType: "jsonata", mergeContext: "", mustacheAltTags: false, outputProperties: [], queue: "all", blockInputOverrides: true, domain: "notify", service: "mobile_app_iphone_de_resident_primary_furlan", x: 920, y: 100, wires: [[]] }),
