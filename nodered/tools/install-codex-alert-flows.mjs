...
if (event.type === "manual_test") {
  const alert = build(
    ...
    "✅ O Node-RED está conectado ao iPhone de Gabriel. Uso atual: " +
...
const nodes = [
  { id: TAB, type: "tab", label: "alertas_codex", disabled: false, info: "Alertas de uso do Codex: lógica e deduplicação no Node-RED; painel e configurações no Home Assistant.", env: [] },
  { id: GROUP, type: "group", z: TAB, name: "Alertas Codex → iPhone de Gabriel", style: { label: true, "label-position": "nw", stroke: "#5d6f96", "stroke-opacity": "1", fill: "none", color: "#a4a4a4" }, nodes: ["codex_alert_state", "codex_alert_test", "codex_alert_daily", "codex_alert_logic", "codex_alert_push", "codex_alert_text", "codex_alert_time", "codex_alert_persistent"], x: 40, y: 40, w: 1520, h: 280 },
  ...
  stateNode("codex_alert_test", "Botão: testar push", ["input_button.codex_testar_alerta_iphone"], false, ["codex_alert_logic"], "{\"type\":\"manual_test\"}"),
  ...
  node("codex_alert_push", "api-call-service", { g: GROUP, name: "Push iPhone Gabriel", server: HA, version: 7, debugenabled: false, action: "notify.mobile_app_iphone_de_gabriel_furlan", floorId: [], areaId: [], deviceId: [], entityId: [], labelId: [], data: "{\"title\":alert.title,\"message\":alert.message}", dataType: "jsonata", mergeContext: "", mustacheAltTags: false, outputProperties: [], queue: "all", blockInputOverrides: true, domain: "notify", service: "mobile_app_iphone_de_gabriel_furlan", x: 920, y: 100, wires: [[]] }),
