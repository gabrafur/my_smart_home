...
const nodes = [
  ...
  functionNode("git_backup_result", "Registrar resultado", recordResult, 4, 880, 150, [["git_backup_notify_primary", "git_backup_notify_persistent"], ["git_backup_dry_run_terminal"], ["git_backup_daily_update_out"], ["git_backup_retry_delay"]]),
  functionNode("git_backup_error", "Registrar erro seguro", recordError, 1, 880, 210, [["git_backup_notify_primary", "git_backup_notify_persistent"]]),
  ...
  {
    id: "git_backup_notify_persistent",
    type: "api-call-service",
    z: TAB,
    g: GROUP,
    name: "Registrar aviso no Home Assistant",
    server: "4126427d5e161a03",
    version: 7,
    debugenabled: false,
    ...
    entityId: [],
    labelId: [],
    data: '{"title":alert.title,"message":alert.message,"notification_id":"git_backup_failure"}',
    dataType: "jsonata",
    mergeContext: "",
    mustacheAltTags: false,
    outputProperties: [],
  ...
  },
  {
    ...
    info: "Os cenários sintéticos entram no mesmo parser de resultado. A fronteira final bloqueia Git, SSH, a notificação mobile e a notificação persistente do Home Assistant.",
    x: 630,
    y: 350,
    wires: [],
  },
