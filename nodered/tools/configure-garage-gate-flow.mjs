...
upsert({ id: "gar_effect_pulse_in", type: "link in", z: TAB, g: "gar_group_effect", name: "Receber pulso decidido", links: ["gar_request_pulse_out"], x: 960, y: 420, wires: [["gar_pulse_test_gate"]] });
upsert({ id: "gar_effect_safe_off_in", type: "link in", z: TAB, g: "gar_group_effect", name: "Receber OFF seguro", links: ["gar_request_safe_off_out"], x: 960, y: 700, wires: [["gar_safe_off_test_gate"]] });
upsert({ id: "gar_pulse_test_gate", type: "switch", z: TAB, g: "gar_group_effect", name: "Gate final: pulso produção ou TESTE?", property: "test_mode", propertyType: "msg", rules: [{ t: "neq", v: "true", vt: "bool" }, { t: "eq", v: "true", vt: "bool" }], checkall: "true", repair: false, outputs: 2, x: 1180, y: 420, wires: [["gar_prepare_pulse_delay"], ["gar_effect_dry_run_out"]] });
upsert({ id: "gar_prepare_pulse_delay", type: "change", z: TAB, g: "gar_group_effect", name: "Aplicar largura da política", rules: [{ t: "set", p: "delay", pt: "msg", to: "policy.pulse_ms", tot: "msg" }], x: 1450, y: 420, wires: [["gar_relay_pulse_on", "gar_log_pulse_started"]] });
upsert(functionNode("gar_relay_pulse_on", "gar_group_effect", "Adaptar MQTT: fechar contato (ON)", mqttCommand("ON"), 1, 2500, 380, [["gar_relay_mqtt_out", "gar_relay_safety_delay"]]));
upsert({ id: "gar_relay_safety_delay", type: "delay", z: TAB, g: "gar_group_effect", name: "Aguardar msg.delay da política", pauseType: "delayv", timeout: "700", timeoutUnits: "milliseconds", rate: "1", nbRateUnits: "1", rateUnits: "second", randomFirst: "1", randomLast: "5", randomUnits: "seconds", drop: false, allowrate: false, outputs: 1, x: 2600, y: 460, wires: [["gar_relay_pulse_off"]] });
upsert(functionNode("gar_relay_pulse_off", "gar_group_effect", "Adaptar MQTT: abrir contato (OFF)", mqttCommand("OFF"), 1, 2800, 500, [["gar_relay_mqtt_out"]]));
upsert({ id: "gar_relay_mqtt_out", type: "mqtt out", z: TAB, g: "gar_group_effect", name: "Efeito: publicar comando do relé", topic: "", qos: "", retain: "", respTopic: "", contentType: "", userProps: "", correl: "", expiry: "", broker: BROKER, x: 3000, y: 380, wires: [] });
upsert({ id: "gar_log_pulse_started", type: "api-call-service", z: TAB, g: "gar_group_effect", name: "Confirmar pedido aceito no Logbook", server: HA_SERVER, version: 7, debugenabled: false, action: "logbook.log", floorId: [], areaId: [], deviceId: [], entityId: [], labelId: [], data: '{"name":"Portão garagem","message":"pulso ÚNICO iniciado (origem: " & request.origin & ") — largura " & policy.pulse_ms & " ms, cooldown " & policy.cooldown_ms & " ms."}', dataType: "jsonata", mergeContext: "", mustacheAltTags: false, outputProperties: [], queue: "none", blockInputOverrides: true, domain: "logbook", service: "log", x: 2050, y: 500, wires: [[]] });
upsert({ id: "gar_safe_off_test_gate", type: "switch", z: TAB, g: "gar_group_effect", name: "Gate final: OFF seguro ou TESTE?", property: "test_mode", propertyType: "msg", rules: [{ t: "neq", v: "true", vt: "bool" }, { t: "eq", v: "true", vt: "bool" }], checkall: "true", repair: false, outputs: 2, x: 1180, y: 700, wires: [["gar_effect_safe_off_adapter_out", "gar_notify_relay_on"], ["gar_effect_dry_run_out"]] });
upsert({ id: "gar_effect_safe_off_adapter_out", type: "link out", z: TAB, g: "gar_group_effect", name: "OFF seguro → adapter MQTT", mode: "link", links: ["gar_effect_safe_off_adapter_in"], x: 1450, y: 660, wires: [] });
upsert({ id: "gar_effect_safe_off_adapter_in", type: "link in", z: TAB, g: "gar_group_effect", name: "Receber OFF seguro", links: ["gar_effect_safe_off_adapter_out"], x: 2500, y: 620, wires: [["gar_relay_pulse_off"]] });
upsert({ id: "gar_effect_dry_run_out", type: "link out", z: TAB, g: "gar_group_effect", name: "TESTE → terminal dry-run", mode: "link", links: ["gar_test_dry_run_in"], x: 1450, y: 560, wires: [] });
upsert({ id: "gar_notify_relay_on", type: "api-call-service", z: TAB, g: "gar_group_effect", name: "Avisar: relé já estava ON", server: HA_SERVER, version: 7, debugenabled: false, action: "persistent_notification.create", floorId: [], areaId: [], deviceId: [], entityId: [], labelId: [], data: '{"notification_id":"portao_garagem_rele_preso","title":"Portão da garagem - relé estava ligado","message":"O relé já estava ON. O Node-RED enviou somente OFF e recusou um novo pulso."}', dataType: "jsonata", mergeContext: "", mustacheAltTags: false, outputProperties: [], queue: "all", blockInputOverrides: true, domain: "persistent_notification", service: "create", x: 1700, y: 740, wires: [[]] });
upsert(group("gar_group_effect", "3. Gate final, efeitos e confirmação", ["gar_effect_pulse_in", "gar_effect_safe_off_in", "gar_pulse_test_gate", "gar_prepare_pulse_delay", "gar_relay_pulse_on", "gar_relay_safety_delay", "gar_relay_pulse_off", "gar_relay_mqtt_out", "gar_log_pulse_started", "gar_safe_off_test_gate", "gar_effect_safe_off_adapter_out", "gar_effect_safe_off_adapter_in", "gar_effect_dry_run_out", "gar_notify_relay_on"], 920, 390, 2160, 500, "#dc2626", "#fee2e2"));
